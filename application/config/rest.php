...
/*
|--------------------------------------------------------------------------
| REST JWT Authentification
|--------------------------------------------------------------------------
|
| No Authentification Required for these services
|
| ControllerName/ControllerMethod_HTTPverb
| 
*/
$config['rest_safe_routes'] = ['production/create_post'];
/*
|--------------------------------------------------------------------------
| REST Login Source
|--------------------------------------------------------------------------
